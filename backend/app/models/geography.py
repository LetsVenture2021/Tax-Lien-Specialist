"""Geographic and property models."""
...
+
+from app.models.enums import AuctionSaleType, CountyAuctionType, LienStatus, LienType, InterestType, PropertyType
...
+
+    county_id: Mapped[PyUUID] = mapped_column(ForeignKey("counties.id", ondelete="CASCADE"))
...
+
+    property_id: Mapped[PyUUID] = mapped_column(ForeignKey("properties.id", ondelete="CASCADE"))
